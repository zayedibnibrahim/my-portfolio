...
import './Home.css'
import myImg from '../../image/zayed-non-bg.png'
      ...
      <div className='row d-flex justify-content-center align-items-center'>
        ...
        <div className='col-md-7 short-des p-md-5 p-2'>
          <Slide bottom>
            ...
            <p>
              I'm a creative React developer with extensive knowledge of both
              front-end and back-end functionalities. Excellent focus,
              communication, and ability to learn rapidly. Excels working in a
              team environment. Strong critical analysis and problem solving. I
