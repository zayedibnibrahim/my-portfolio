...
import './About.css'
import selfAvatar from '../../image/anikzayed-square.jpg'
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome'
import { faFileDownload, faEye, faCode, faEnvelope } from '@fortawesome/free-solid-svg-icons';
            ...
            <div className="container">
                ...
                <div className="row d-flex justify-content-center align-items-center">
                    <div className="col-md-6 border-end pt-5 pb-5">
                        ...
                        <h3 className="text-white mt-5"><span>I'm</span> <span className="brand-color">Zayed Ibn Ibrahim.</span></h3>
                    ...
                    <div className="col-md-6 pt-5 pb-5">
                        <Slide right>
                            <h3 className="text-white"><FontAwesomeIcon icon={faCode} /> Programming Skills</h3>
